...
public class SPPEquipoPFP3 {
    ...
    public static void main(String[] args) {
        ...
        boolean flag = true;
         do{
                OPCION = SolicitarEntero ("Ingrese la opción deseada: \n"
        ...
        case 1:
        int a = SolicitarEntero("Introduce el primer número");
        int b = SolicitarEntero("Introduce el segundo número");
        ...
        case 2:
        a = SolicitarEntero("Número 1");
        b = SolicitarEntero("Número 2");
        menor = Math.min(a, b);
        int mcm = 0;
